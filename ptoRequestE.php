	...
	*/
	...
	if ($cmonth < 7) { //if current month is prior to July
		...
		if ($rolloverPTO <= $maxRO){ 
			//$updateRO = "UPDATE outboard SET rollover_pto_hours = $rolloverPTO WHERE `userid` like '%matt%'"; //for testing
			...
			$rolloverPTO = $maxRO;
			//$updateRO = "UPDATE outboard SET rollover_pto_hours = $maxRO WHERE `userid` like '%matt%'"; //for testing
	...
	//$updateTotal = "UPDATE outboard SET total_pto_hours = $ptoTotalHours WHERE `userid` like '%matt%'"; //for testing
	...
	//$addAvail = "UPDATE outboard SET pto_hours = $ptoAvailableHours WHERE `userid` like '%matt%'"; //for testing
