  ...
  <!-- Outboard CSS -->
  <link rel="stylesheet" type="text/css" href="/css/util.css?v1.0.0.6">
  ...
  <link rel="stylesheet" type="text/css" href="/css/wsb.style.css?v1.0.0.12">
  <link rel="stylesheet" type="text/css" href="/css/ob.scrollbar.css">
	<!-- Bootstrap core CSS -->
  ...
  <?php } ?>
  <link rel="stylesheet" type="text/css" href="/css/maintest.css?=v1.0.0.6.21">
...
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
  ...
  <link rel="stylesheet" type="text/css" href="css/buttonhidetext.css?v1">
