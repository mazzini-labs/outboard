            ...
            <form id="insert_well_form" name="insert_well_form" class="" method="POST">
                <div class="modal-body mr-5">
                    <div class="row mx-auto">
                        ...
                        <div id="api-hide-spacer" class="hidden w-100"></div>
                        <div id="api-hide-div" class=<?php if(active('wsb.php')) {echo "col";} else {echo "hidden col";} ?> >
                            <div class="input-group input-group-sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">API No.</span>
                                </div>
                                <input type="search" name="api" id="api" class="form-control" value=<?php echo $api; ?> >
                            </div>
                        </div>
                        <div class="w-100"></div>
                        <div class="col">
                            ...
                            <div class="col">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input name="efield" id="efield" type="text" class="form-control" >
                                </div>
                            ...
                            <div class="col">
                                <div class="input-group input-group-sm">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">Landowner</span>
                                    </div>
                                    <input name="landowner" id="landowner" type="text" class="form-control" >
                                </div>
                            </div>
                            <div class="col">
                                <div class="input-group input-group-sm">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">Gate Combo</span>
                                    </div>
                                    <input name="gatecombo" id="gatecombo" type="text" class="form-control" >
                                </div>
                            </div>
                            <div class="w-100"></div>
                            <div class="col">
                                <div class="input-group input-group-sm">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">Landowner Notes</span>
                                    </div>
                                    <textarea name="landowner_notes" id="landowner_notes" type="text" class="form-control" ></textarea>
                                </div>
                            </div>
                            <div class="w-100"></div>
                            <div class="col">
                        ...
                        <div class="ddr-e input-group p-1">
                            <input type="submit" name="insert-well" id="insert-well" value="Insert" class="btn btn-success m-3" />
                            <button type="button" class="ddr-e btn btn-secondary m-3" data-dismiss="modal">Close</button>
                        </div>

                        <input type="hidden" name="id" id="id" class="" value=<?php echo $cp; ?>>
