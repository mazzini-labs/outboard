...
<head>
    ...
    <!-- <script type="text/javascript" class="init" src="/js/datatables.wsb.testing.js?v1.0.0.20"></script>
    <script src="/js/wsb.ddr.js?v1.0.0.27"></script> -->
    <script type="text/javascript" class="init" src="/js/datatables.wsb.prod_data.js?v1.0.0.32"></script>
</head>
        ...
        <nav class="nav-scroller bg-white shadow-sm nav-underline" style="height: auto; ">
            ...
            <?php if(isset($_REQUEST["testing"])){ ?>
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="latest-tab" data-toggle="tab" href="#latest" role="tab" aria-controls="latest" aria-selected="true">Latest Daily Production [TESTING]</a>
                </li>
                <?php } ?>
                <li class="nav-item" role="presentation">
                <?php if(isset($_REQUEST["testing"])){ ?>
                    <a class="nav-link" id="monthly-tab" data-toggle="tab" href="#home" role="tab" aria-controls="monthly" aria-selected="true">Monthly Production </a>
                <?php } else { ?>
            ...
            <div class="tab-content" id="myTabContent" style="z-index:1!important;">
                <?php if(isset($_REQUEST["testing"])){ ?>
                <div class="tab-pane fade show active" id="latest" role="tabpanel" aria-labelledby="latest-tab" style="position: relative; z-index: 940;"> 
                ...
                <?php } ?>
                <?php if(isset($_REQUEST["testing"])){ ?>
                    <div class="tab-pane fade " id="home" role="tabpanel" aria-labelledby="monthly-tab" style="position: relative; z-index: 940;"> 
                <?php } else { ?>
...
<script src="/js/bottom_scripts.js?v1.0.0.2"></script>
