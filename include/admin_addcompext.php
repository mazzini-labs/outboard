...
$editthisuser = getGetValue('compEdit');
$table = $_GET['table'];
...
if (isset($editthisuser)) {
    ...
    $row = $ob->getRow();
    $name = $row['misc'];
    $extension = $row['extension_or_other'];
    $submit_button = 
...
<div class="container">
  <div class="row">
   ...
   <div class="row">
      <div class="col">Company + Contact Type:</div>
      <div class="col"><input class="input200" type=text name=newcompname placeholder="Spindletop Phone" size=20 maxlength=50 
	   value="<?php echo $name ?>"></div>
  </div>
  <div class="row">
      <div class="col">Contact Info:</div>
      <div class="col"><input class="input200" type=text name=newcompextension placeholder="972-644-2581" size=20 maxlength=30
