	 ...
	 <?php if($ob->isReadonly()) { $readonly = true; } else { $readonly = false; }?>
      ...
      <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          ...
          <a class="nav-link dropdown-toggle" href="#" id="calendardropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Timesheets</a>
        ...
        <?php } else { ?>
		 ...
		 <li class="nav-item">
				  				<?php if ($ob->isAdmin()) { ?>
					  <a class="nav-link active" href="outboard.php?adminscreen=1">Admin</a>
				  <?php } ?>
      </li>
      <li class="nav-item">
