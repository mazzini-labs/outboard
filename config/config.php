...
//
// 2009-05-07, richardf - 2.2.5 - Bug fix release.
...
// Set the error reporting level. Use E_ALL for debugging.
...
$this->config['ptotable'] = "pto_request";  // logging table for changes
// TESTING: for PDO class
$this->config['host']   = "localhost"; 
$this->config['dbname']       = "outboard";
$this->config['driver'] = 'mysql';
$this->config['username']   = "outuser";	// username for above database 
$this->config['password']   = "outpass";	// password for above username 
$this->config['localhost'] = array(
	'driver' => 'mysql',
	'host' => 'localhost',
	'dbname' => 'outboard',
	'username' => 'outuser',
...
$this->config['allow_change'] = "user_admin";

// The Title of the board
$this->config['board_title'] = "Spindletop Oil & Gas Co.";
...
//$this->config['periodstart'] = "2007-12-30";  //original; changed to 2008-01-01 to try to get more accurate numbers
$this->config['periodstart'] = "2008-01-01";  
...
// Email addresses for sending PTO requests
$this->config['hr'] = "hr@spindletopoil.com";
$this->config['ap'] = "apsupervisor@spindletopoil.com";
$this->config['a1'] = "accountingsupervisor@spindletopoil.com";
$this->config['a2'] = "accountingmanagersupervisor@spindletopoil.com";
$this->config['e1'] = "engineeringsupervisor@spindletopoil.com";
$this->config['e2'] = "engineeringtwosupervisor@spindletopoil.com";
$this->config['land'] = "landsupervisor@spindletopoil.com";
$this->config['legal'] = "legalsupervisor@spindletopoil.com";
$this->config['geo'] = "geologysupervisor@spindletopoil.com";
$this->config['adstaff'] = "adminsupervisor@spindletopoil.com";
...
$this->config['dot_image']    = "circle.svg";
//$this->config['out_image']    = "g.png";
$this->config['out_image']     = "x-circle.svg";
//$this->config['in_image']     = "gr.png";
$this->config['in_image']     = "check-circle.svg";
...
//$this->config['td_zebra2']   = "#ddd"; // background color of alternating rows
//$this->config['td_user_bg']  = "#3366cc"; // background color when editing user's info
//$this->config['td_text']     = "#000000"; // text color in the table cells
//$this->config['td_lines']    = "#d0d0d0"; // color of the "lines" in the outboard
...
$this->config['max_visible_length'] = 200;

// The format of the date shown at the top of the page
$this->config['date_format'] = "h:i:sa  D, m.d.Y";
$this->config['time_format']= "h:i:sa";
$this->config['caldate_format']= "D, m.d.Y";
...
$this->config['version'] = "2.2.5";            // Don't change this
$this->config['version_date'] = "2009";      // Don't change this
