...
<script language = "javascript" type = "text/javascript">
 function PD(){
	   ...
	   //var hours = document.getElementById('hours').value; //UNCOMMENT WHEN READY TO TEST WITH CALENDAR
	   ...
	   //UNCOMMENT WHEN READY TO TEST WITH CALENDAR //queryString +=  "&hours=" + hours;  // + "&reportchoice=" + reportchoice;// + "&userid=" + userid;
	   ajaxRequest.open("GET", "ptoRequest.php" + queryString, true);
...
-->
	<div class="col">
		<input class="input100" name="partHours" id="hours" type="text" placeholder="Requested Hours"> 
