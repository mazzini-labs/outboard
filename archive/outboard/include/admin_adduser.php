...
if ($editthisuser > 0) {
  ...
  $rochecked = "";
  $adminchecked = "";
  $submit_button = "<input class='login200-form-btn' type=submit name=addnewuser value=\"Add This User\">";
}
...
<table border=0>
  ...
  <tr>
      ...
      <input class="login200-form-btn" type=submit name=cancel value="Cancel">
      </td>
  </tr>
