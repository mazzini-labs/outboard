...
<!--a class="active" href="#">Home</a-->
  ...
  <?php } else { echo "&nbsp;"; } ?>
 <?php if ($ob->isAdmin()) { ?>
  <a href="tc.php" target=_blank>Timesheet</a>
<?php } else { ?>
  <a href="tcfEmp.php" target=_blank>Timesheet</a>
<?php } ?>
...
<!--
  <?php if ($ob->isEligible()) { ?>
      <a class="navbar" href="pto.php">PTO Request</a>
  <?php } ?> 
//testing for BLM & MHM to use-->
	<a href="pto.php" target=_blank>PTO Request</a>
	<a href="approvePTO.php" target=_blank>Approve PTO</a>
	<a href="calendartest.php" target=_blank>Calendar</a>
