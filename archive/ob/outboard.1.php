...
<style>
  .fc-toolbar h2 { color: white!important; }
  .fc > a { color: white!important;  }
  th.fc-day-header,.fc-widget-header,.fc-sun,.fc-past, a.fc-more, span.fc-title { color: white!important;  }
  .fc-time, .fc-widget-content,.fc-axis { color: white!important; border-color: }
  .fc-daygrid-day-number { opacity: .3;}
  .fc-unthemed .fc-content, .fc-unthemed .fc-divider, .fc-unthemed .fc-list-heading td, 
  .fc-unthemed .fc-list-view, .fc-unthemed .fc-popover, .fc-unthemed .fc-row, .fc-unthemed tbody, 
  .fc-unthemed td, .fc-unthemed th, .fc-unthemed thead { border-color: rgba(155,155,155,1)!important;}
  .fc-unthemed .fc-divider, .fc-unthemed .fc-list-heading td, .fc-unthemed .fc-popover .fc-header { background-color: rgba(238,238,238,0.3)!important;}
  .fc-ltr .fc-dayGrid-view .fc-day-top .fc-day-number { color: rgba(255,255,255,0.5)!important;}
  .fc-unthemed td.fc-today { background: #e35a17!important; } 
</style>
...
<div style="display:flex;position:fixed;left:2.5em;bottom:2.5em;z-index:1030"> 
 ...
 <main role="main tab-pane active">
  <div class="carded bg-light"> -->
    <div class="row justify-content-center">
      <div class="col-4 m-3 p-3 shadow-lg carded-body bg-dark">
        <table id="table" class="table bg-dark text-white table-hover table-dark table-borderless smol">
        <thead><tr>
            <th>Name</th>
            <th>Core Hours</th>
            <th>In</th>
          ...
          while($row = $ob->getRow()) {
            ...
            if ($row['userid'] == $username && $update && $isChangeable) {
              ...
              if ($update && $isChangeable) {
                echo "<td $user_bg'><a style='color: white;' href=\"javascript:this.change_remark('"
      ...
      <div class="col-6 m-3 p-3 shadow-lg carded-body bg-dark"><div id="calendar"></div>
...
<?php if (! $update && ! $readonly) { ?>
          <a class="btn-floating btn-lg btn-info bg-sog cs" href="/outboard.1.php?update=1#<?php echo $username ?>"> <!-- data-toggle="tooltip" data-placement="left" title="Change Status"> -->
          <i class="lg-icon" data-feather="edit-3" ></i>
        <?php } elseif (! $readonly) { ?>
          <a class="btn-floating btn-lg btn-info bg-sog vs" href="/outboard.1.php?noupdate=1"> <!-- data-toggle="tooltip" data-placement="left" title="View Status"> -->
