                ...
                <div class="container-fluid" style="background-color:white;">
                    <table id="ddrTable" class='table display  bg-sog table-striped table-borderless datatable-tab-correct datatable-tab-correct1 table-sm' style="margin-top: 0px !important; width: 100% !important;" >
                        <thead>
                                ...
                                <th <?php echo $width14; ?>>Invoice Details / DDR</th>
                                <th <?php echo $width2; ?>>$ / EDC</a></th>
                                <th <?php echo $width2; ?>>Approvals / ECC</a></th>
                                <th <?php echo $width2; ?>>Actions</th>
                        </thead>
                        <?php
                        $ddr = "new_ddr";
                        ...
                        //for ($i = $_GET['start']; $i < $_GET['end']; $i++)
                        {
                            ...
                            if($type != "dsr")
                            {
                                ...
                                {
                                    case "eng":
                                        $ddr_date = $datarow['date'];
                                        $time_start = $datarow['time_start'];
                                        $time_end = $datarow['time_end'];
                                        $eng_contact = $datarow['eng_contact'];
                                        $eng_contact_info = $datarow['eng_contact_info'];
                                        $eng_daily_report = $datarow['eng_daily_report'];
                                        $eng_edc = $datarow['eng_edc'];
                                        $eng_ecc = $datarow['eng_ecc'];
                                        $data_entry_by = $datarow['data_entry_by'];
                                        $submission_date = $datarow['submission_date'];
                                        echo "<tr>\n";
                                        echo '<td class="engineering" '.$width1.'>
                                                <span class="custom-checkbox">
                                        ...
                                        echo "<td class='engineering' $width7><small>$time_start - $time_end</td ></small>\n";
                                        echo "<td class='engineering' $width4><small>$eng_contact</a></td ></small>\n";
                                        echo "<td class='engineering' $width2><small>$eng_contact_info</td ></small>\n";
                                        echo "<td class='engineering' $width14><small>$eng_daily_report</small> </td >\n";
                                        echo "<td class='engineering' $width2><small>$eng_edc</td ></small>\n";
                                        echo "<td class='engineering' $width2><small>$eng_ecc</td ></small>\n";
                                        echo '<td class="engineering" '.$width2.'>
                                    ...
                                    case "acct":
                                        ...
                                        $time_start = $datarow['time_start'];
                                        $time_end = $datarow['time_end'];
                                        $acct_vendor = $datarow['acct_vendor'];
                                        $acct_invoice_no = $datarow['acct_invoice_no'];
                                        $acct_invoice_details = $datarow['acct_invoice_details'];
                                        $acct_invoice_amt = $datarow['acct_invoice_amt'];
                                        $acct_approval_initials = $datarow['acct_approval_initials'];
                                        $acct_approval_date = $datarow['acct_approval_date'];
                                        $data_entry_by = $datarow['data_entry_by'];
                                        $submission_date = $datarow['submission_date'];
                                        echo "<tr>\n";
                                        echo '<td class="accounting" '.$width2.'>
                                                <span class="custom-checkbox">
                                                    <input type="checkbox" id="checkbox'.$i.'" name="options[]" value="1">
                                                    <label for="checkbox'.$i.'"></label>
                                                </span>
                                        ...
                                        echo "<td class='accounting' $width7><small>$time_start - $time_end</td ></small>\n";
                                        echo "<td class='accounting' $width4><small>$acct_vendor</a></td ></small>\n";
                                        echo "<td class='accounting' $width2><small>$acct_invoice_no</td ></small>\n";
                                        echo "<td class='accounting' $width14><small>$eng_daily_report</small> </td >\n";
                                        echo "<td class='accounting' $width2><small>$eng_edc</td ></small>\n";
                                        echo "<td class='accounting' $width2><small>$eng_ecc</td ></small>\n";
                                        echo '<td class="accounting" '.$width2.'>
                                                <a href="#editEmployeeModal" class="edit" data-toggle="modal"><img src='.$image_dir.'/edit.svg border=0 data-toggle="tooltip" title="Edit"></a>
                                                <a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><img src='.$image_dir.'/trash-2.svg border=0 data-toggle="tooltip" title="Delete"></a>
                                            </td>';
                                    ...
                                    case "vendor":
                                        ...
                                        $vend_deduct_time = ($datarow['vend_deduct_time'] != '') ? $datarow['vend_deduct_time'] : "&nbsp;";
                                        $vend_deduct_reason = ($datarow['vend_deduct_reason'] != '') ? $datarow['vend_deduct_reason'] : "&nbsp;";
                                        $vend_adjust_hrs = ($datarow['vend_adjust_hrs'] != '') ? $datarow['vend_adjust_hrs'] : "&nbsp;";
                                        $vend_adjust_cost = ($datarow['vend_adjust_cost'] != '') ? $datarow['vend_adjust_cost'] : "&nbsp;";
                                        $vend_est_travel = ($datarow['vend_est_travel'] != '') ? $datarow['vend_est_travel'] : "&nbsp;";
                                        $vend_total_hours = ($datarow['vend_total_hours'] != '') ? $datarow['vend_total_hours'] : "&nbsp;";
                                        ...
                                        echo "<td class='vendor'$width7><small>$vend_aol - $vend_ll</td ></small>\n";
                                        echo "<td class='vendor'$width4><small>$vend_name</a></td ></small>\n";
                                        echo "<td class='vendor'$width2><small>$vend_service</td ></small>\n";
                                        echo "<td class='vendor'$width14><small>Deduction Hrs: $vend_deduct_time | Deduction Reasons: $vend_deduct_reason</small> </td >\n";
                                        echo "<td class='vendor'$width2><small>Adjusted Hrs/$: $vend_adjust_hrs / $vend_adjust_cost</td ></small>\n";
                                        echo "<td class='vendor'$width2><small>Est. Travel Time: $vend_est_travel | Total Time: $vend_total_hours</td ></small>\n";
                                        echo '<td class="vendor" '.$width2.'>
                                                <a href="#editEmployeeModal" class="edit" data-toggle="modal"><img src='.$image_dir.'/edit.svg border=0 data-toggle="tooltip" title="Edit"></a>
                                                <a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><img src='.$image_dir.'/trash-2.svg border=0 data-toggle="tooltip" title="Delete"></a>
                                            </td>';
                                    ...
                                    default:
                                        ...
                                        echo "<td class='field' $width2><small>$ddr_date</td ></small>\n";
                                        echo "<td class='field' $width7><small>$time_start - $time_end</td ></small>\n";
                                        echo "<td class='field' $width4><small>$eng_contact</a></td ></small>\n";
                                        echo "<td class='field' $width2><small>$eng_contact_info</td ></small>\n";
                                        echo "<td class='field' $width14><small>$eng_daily_report</small> </td >\n";
                                        echo "<td class='field' $width2><small>$eng_edc</td ></small>\n";
                                        echo "<td class='field' $width2><small>$eng_ecc</td ></small>\n";
                                        echo '<td class="field" '.$width2.'>
                                                <a href="#editEmployeeModal" class="edit" data-toggle="modal"><img src='.$image_dir.'/edit.svg border=0 data-toggle="tooltip" title="Edit"></a>
                                                <a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><img src='.$image_dir.'/trash-2.svg border=0 data-toggle="tooltip" title="Delete"></a>
                                            </td>';
