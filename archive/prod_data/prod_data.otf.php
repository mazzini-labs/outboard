		...
		<div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade " id="ddr" role="tabpanel" aria-labelledby="ddr-tab" style="position: relative; z-index: 1040;">
                <div class="carded m-3 p-3 shadow-lg">
                    ...
                    <div class="carded-body"><table id="ddrTable" class='table display table-striped table-borderless datatable-tab-correct datatable-tab-correct1 table-sm table-hover' style="margin-top: 0px !important; width: 100% !important;" >
                        <thead class=" bg-sog ">
            ...
            <div class="tab-pane fade " id="t1" role="tabpanel" aria-labelledby="t1-tab" style="position: relative; z-index: 1040;">
                ...
                <div class="carded-body"><table id="ddr2015pres" class="table table-striped table-borderless datatable-tab-correct datatable-tab-correct1 table-sm table-hover" style="width=100%;">
                        <thead class="bg-sog">
                            <tr>
            ...
            <div class="tab-pane fade " id="t3" role="tabpanel" aria-labelledby="t3-tab" style="position: relative; z-index: 1040;">
                ...
                <div class="carded-header">
                    ...
                    <div class="carded-body"><table id="before2015detailrpt" class="table display table-striped table-borderless datatable-tab-correct datatable-tab-correct1 table-sm table-hover" style="width=100%;">
                        <thead class="bg-sog">
                            <tr>
                                <!-- <th class="table-header">&nbsp;</th> -->
            ...
            <div class="carded m-3 p-3 shadow-lg">
                <div class="carded-header">
                    ...
                    <div class="carded-body><table id="before2015sumrpt" class="table display table-striped table-borderless datatable-tab-correct datatable-tab-correct1 table-sm table-hover" style="width=100%;">
                        <thead class="bg-sog">
                            <tr>
                                <th class="table-header">&nbsp;</th>
                                <th class="table-header">A</th>
    ...
    <div class="modal-dialog modal-lg modal-side modal-top-right" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalPreviewLabel">Add New DDR Entry</h5>
                    ...
                    <div class="tab-pane fade in show active" id="pills-eng" role="pillpanel">
                        <form id="insert_form-e" method="POST">
                            <div class="input-group mb-3">
                                ...
                                <input id="de-e" name="de-e" type="text" class="form-control date datepicker-input" value="" required>
                                <input name="deb-e" id="deb-e" type="text" class="form-control" placeholder="Your Name" aria-label="Data Entry By" required>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="time" value="08:00" step="600" class="form-control" name="ts-e" id="ts-e" required>
                                <input type="time" value="08:00" step="600" class="form-control" name="te-e" id="te-e" required>
                                <div class="input-group-append">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input name="cvn-e" id="cvn-e" type="text" class="form-control" required>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <textarea name="drn-e" id="drn-e" class="form-control" aria-label="With textarea" required></textarea>
                                </div>
                                <div class="input-group mb-3">
                                <div class="input-group-prepend">
                            ...
                            <div class="input-group p-1">
                                <input type="submit" name="insert-e" id="insert-e" value="Insert" class="btn btn-success m-3" />
                        ...
                        <div class="tab-pane fade" id="pills-acct" role="tabpanel">
                            <form id="insert_form-a" method="POST">
                                <div class="input-group mb-3">
                                    ...
                                    <input id="de-a" name="de-a" type="text" class="form-control date datepicker-input" required>
                                    <input name="deb-a" id="deb-a" type="text" class="form-control" placeholder="Your Name" aria-label="Data Entry By" required>
                                    <div class="input-group-append">
                                        <span class="input-group-text">Person Entering Data</span>
                                    </div>
                                </div>
                                <div class="input-group mb-3">
                                    ...
                                    <input type="time" value="08:00" step="600" class="form-control" name="ts-a" id="ts-a" required>
                                    <input type="time" value="08:00" step="600" class="form-control" name="te-a" id="te-a" required>
                                    <div class="input-group-append">
                                        <span class="input-group-text">End Time</span>
                                    </div>
                                </div>
                                <div class="input-group mb-3 ">
                                    ...
                                    <input id="cvn-a" name="cvn-a" type="text" class="form-control" placeholder="Vendor" aria-label="Vendor" required>
                                </div>    
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">Invoice #</span>
                                    </div>
                                    <input id="cin-a" name="cin-a" type="text" class="form-control" aria-label="Invoice #" required>
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">$</span>
                                    </div>
                                ...
                                <hr class="mb-0">
                                <div class="input-group p-1">
                                    <input type="submit" name="insert-a" id="insert-a" value="Insert" class="btn btn-success m-3" />
                                    <button type="button" class="btn btn-secondary m-3" data-dismiss="modal">Close</button>
                                </div>
                            </form>
                        </div>
                        ...
                        <form id="insert_form-v" method="POST">
                            <div class="input-group mb-3">
                                ...
                                <input id="de-v" name="de-v" type="text" class="form-control date datepicker-input" required>
                                <input name="deb-v" id="deb-v" type="text" class="form-control" placeholder="Your Name" aria-label="Data Entry By" required>
                                <div class="input-group-append">
                                    <span class="input-group-text">Person Entering Data</span>
                                </div>
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">Vendor AOL</span>
                                </div>
                                <input type="time" value="08:00" step="600" class="form-control" name="ts-v" id="ts-v" required>
                                <input type="time" value="08:00" step="600" class="form-control" name="te-v" id="te-v" required>
                                <div class="input-group-append">
                                    <span class="input-group-text">Vendor LL</span>
                                </div>
                            </div>			
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                ...
                                <input id="cvn-v" name="cvn-v" type="text" class="form-control" required>
                                <input id="cin-v" name="cin-v" type="text" class="form-control" required>
                                <div class="input-group-append">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <textarea id="drn-v" name="drn-v" class="form-control" aria-label="With textarea" required></textarea>
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">$</span>
                                </div>
                                <input id="vca" name="vca" type="text" class="form-control" aria-label="Vendor Adjusted Hours">
                                <div class="input-group-append">
                                ...
                                <input id="tc-v" name="tc-v" type="text" class="form-control" aria-label="Amount (to the nearest dollar)"  required>
                                <div class="input-group-append">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="vta" name="vta" type="text" class="form-control" aria-label="Amount (to the nearest dollar)">
                                <div class="input-group-append">
                                ...
                                <input id="vte" name="vte" type="text" class="form-control" aria-label="Vendor Adjusted Hours">
                                <div class="input-group-append">
                                    <span class="input-group-text">Hour(s)</span>
                                </div>
                            </div>
                            <div class="input-group mb-3">
                                ...
                                <input id="dc-v" name="dc-v" type="text" class="form-control" aria-label="Amount (to the nearest dollar)"  required>
                                <div class="input-group-append">
                                    <span class="input-group-text">Hour(s)</span>
                                </div>
                            ...
                            <hr class="mb-0">
                            <div class="input-group p-1">
                                <input type="submit" name="insert-v" id="insert-v" value="Insert" class="btn btn-success m-3" />
                                <button type="button" class="btn btn-secondary m-3" data-dismiss="modal">Close</button>
                            </div>
                            </form>
                        </div>
                        ...
                        <form id="insert_form-f" method="POST">
                            <div class="input-group mb-3">
                                ...
                                <input id="de-f" name="de-f" type="text" class="form-control date datepicker-input" required>
                                <input name="deb-f" id="deb-f" type="text" class="form-control" placeholder="Your Name" aria-label="Data Entry By" required>
                                <div class="input-group-append">
                                    <span class="input-group-text">Person Entering Data</span>
                                </div>
                            </div>
                            <div class="input-group mb-3">
                                ...
                                <input type="time" value="08:00" step="600" class="form-control" name="ts-f" id="ts-f" required>
                                <input type="time" value="08:00" step="600" class="form-control" name="te-f" id="te-f" required>
                                <div class="input-group-append">
                                    <span class="input-group-text">End Time</span>
                                </div>
                            </div>					
                            <div class="input-group mb-3">
                                ...
                                <input id="cvn-f" name="cvn-f" type="text" class="form-control" required>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <textarea id="drn-f" name="drn-f" class="form-control" aria-label="With textarea" required></textarea>
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">$</span>
                            ...
                            <hr class="mb-0">
                            <div class="input-group p-1">
                                <input type="submit" name="insert-f" id="insert-f" value="Insert" class="btn btn-success m-3" />
                                <button type="button" class="btn btn-secondary m-3" data-dismiss="modal">Close</button>
                            </div>
                            </form>
                            </div>
...
<div class="modal fade right" id="add_data_dsr_Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalPreviewLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-side modal-top-right" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalPreviewLabel">Add New DSR Entry</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="insert_form-s" method="POST">
                <div class="modal-body">
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text">Date Entered</span>
                        </div>
                        <input id="de-s" name="de-s" type="text" class="form-control date datepicker-input" value="">
                        <input name="deb-s" id="deb-s" type="text" class="form-control" placeholder="Your Name" aria-label="Data Entry By">
                        <div class="input-group-append">
                            <span class="input-group-text">Person Entering Data</span>
                        </div>
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group mb-3">
                            ...
                            <textarea name="drn-s" id="drn-s" class="form-control" aria-label="With textarea"></textarea>
                        </div>
                        <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text">$</span>
                        </div>
                        <input name="dc-s" id="dc-s" type="text" class="form-control" aria-label="Amount (to the nearest dollar)">
                        <div class="input-group-append">
                            <span class="input-group-text">Estimated Daily Cost</span>
                        </div>
                        <div class="input-group-prepend">
                        ...
                        <input name="tc-s" id="tc-s" type="text" class="form-control" aria-label="Amount (to the nearest dollar)">
                        <div class="input-group-append">
                            <span class="input-group-text">Estimated Cumulative Cost</span>
                        </div>
                        <input type="hidden" name="id-s" id="id-s" />
                        <input type="hidden" name="api-s" id="api-s" value=<?php echo $api; ?> />
                        <input type="hidden" name="d-s" id="d-s" value="e" />
                        <input type="hidden" name="t-s" id="t-s" value="d" />     
                        <!-- </form> -->
                    </div>
                </div>
                <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <input type="submit" name="insert-s" id="insert-s" value="Insert" class="btn btn-success" />
                </div>
            </form>
        </div>
    </div>
