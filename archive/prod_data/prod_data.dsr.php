...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/fixed-action-button.css?v.1.0.0.0">
...
<!-- <div class="dropup  app-fab--absolute">
    <button type="button" id="default-fab" data-toggle="dropdown" class="btn btn-primary bmd-btn-fab dropdown-toggle">
    <i class="material-icons">add</i>
    </button>
    <ul class="zoom-menu">
        <li><a class="btn-primary bmd-btn-fab scale-transition scale-out"><i class="material-icons" style="line-height: 40px!important;">add</i></a></li>
        <li><a class="btn-secondary bmd-btn-fab scale-transition scale-out">report</a></li>
    </ul>
    <div class="dropdown-menu">
        <button type="button" id="default-fab" class="btn btn-primary bmd-btn-fab dropdown-item">
        <i class="material-icons">add</i>
        </button>
...
<div class="fixed-action-btn" style="bottom: 45px; right: 24px; z-index:1500;">
    ...
    <ul class="list-unstyled">
      <li><a class="btn-floating btn-info" data-toggle="tooltip" data-placement="left" title="DDR"><i class="sm-icon" data-feather="plus" ></i></a></li>
      <li><a class="btn-floating btn-secondary" data-toggle="tooltip" data-placement="left" title="DSR"><i class="sm-icon" data-feather="plus" ></i></a></li>
    </ul>
  </div>
<!-- <div class="zoom">
  <a class="zoom-fab zoom-btn-large btn-success bmd-btn-fab" id="zoomBtn" data-toggle="tooltip" data-placement="left" title="Add New Entry"><i class="material-icons" style="line-height: 60px!important;">add</i></a>
  <ul class="zoom-menu">
    <li><div class="row"><a class="zoom-fab zoom-btn-sm btn-primary bmd-btn-fab scale-transition scale-out" data-toggle="tooltip" data-placement="left" title="DDR"><i class="material-icons" style="line-height: 40px!important;">add</i></a></div></li>
    <li><div class="row"><a class="zoom-fab zoom-btn-sm btn-secondary bmd-btn-fab scale-transition scale-out" data-toggle="tooltip" data-placement="left" title="DSR">report</a></div></li>
  </ul>
  <div class="zoom-card scale-transition scale-out">
    <ul class="zoom-card-content">
      <li>Add New DDR Entry</li>
      <li>Add New DSR Entry</li>
    </ul>
  </div>
</div> -->
<!-- <div class="zoom" style="bottom: 45px; right: 24px; z-index:1500;">
