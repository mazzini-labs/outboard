...
$userHash = Array();
$currentUser = $tempUserHash[$username];
...
<head>
    ...
    <link rel="stylesheet" href="css/dark-mode.css?v1.0
    ...
    <script src="/js/dropdown.js?v=1.0.0.3"></script>
        ...
        <script type="text/javascript" src="js/datatables.prod_data.js?v=1.0.0.2"></script>
		...
		<ul class="nav justify-content-center" id="myTab" role="tablist" style="position: relative; z-index: 1040; padding-bottom: 0px;">
            ...
            <li class="nav-item" >
                <div class="custom-control custom-switch">
                    ...
                    <label class="custom-control-label text-dark" for="darkSwitch">Dark Mode</label>
                </div>
		...
		<div class="tab-content" id="myTabContent">
			...
			<div class="tab-pane fade in show active" id="detail" role="tabpanel" aria-labelledby="detail-tab" style="position: relative; z-index: 1040;"> 
				...
				<script>
                    ...
                    // if(document.body.setAttribute("data-theme", "dark") == false)
                    // {
                    ...
                    // }
                    // darkSwitch.checked ? console.log("checkbox is checked") : console.log("checkbox is not checked");
...
<?php 
include 'floating_action_button.1.php';
include 'ddr_add_modal.1.php'; 
include 'ddr_datepicker.php'; 
include 'dsr_add_modal.php';
?>
