...
<nav class="navbar navbar-expand-md nav-scroller navbar-dark bg-dark pt-5 pb-5">
	 <?php if($ob->isReadonly()) { $readonly = true; } else { $readonly = false; }?>
      ...
      <!-- WSB -->
        ...
        <div class=row><div class=col><?php// if (! $BasicAuthInUse) { ?>
          ...
          <!-- <div class="btn-group-vertical btn-group-sm align-top" style="z-index: 1041;"> -->
            ...
            <!-- <a href="#deleteEmployeeModal" data-toggle="modal"><i data-feather="circle"></i></a>
            <a href="#deleteEmployeeModal" data-toggle="modal"><i data-feather="circle"></i></a> -->
            </div>	
            <!-- <div class="btn-group btn-group-sm"> -->
            <!-- <a href="#deleteEmployeeModal" data-toggle="modal"><i data-feather="square"></i></a> -->
            <!-- <a href="https://example.com" class="btn btn-success" data-toggle="modal"><span>Add Engineering Entry</span></a> -->
            <!-- <a href="#deleteEmployeeModal" data-toggle="modal"><i data-feather="circle"></i></a>		 -->
            <!-- </div>	 -->
          <!-- </div>	 -->
