...
/*
    ...
    <div class='pt-5 '>
        ...
        <main role="main" class="pt-5">
            ...
            <table id="productionTable" class='table bg-dark table-striped table-borderless datatable-tab-correct datatable-tab-correct1 table-sm' style="margin-top: 0px !important;" >
        ...
        ?> 
            ...
            <table id="productionTable1" class='table bg-dark table-striped table-borderless datatable-tab-correct datatable-tab-correct1 table-sm' style="margin-top: 0px !important;" >
