...
<head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="datatables/FixedHeader-3.1.7/css/fixedHeader.bootstrap4.css"/> -->
    <script type="text/javascript" src="datatables/datatables.min.js"></script>
    <!-- <script type="text/javascript" src="datatables/FixedHeader-3.1.7/js/fixedHeader.bootstrap4.js"></script> -->
<!--     
...
/* ul {position: -webkit-sticky; position: sticky;} */
...
/*
    ...
    <div class=' '>
        ...
        <main role="main" class="pt-5">
            ...
            <ul class="nav nav-tabs justify-content-center pt-2" id="myTab" role="tablist" style="position: relative; z-index: 1040;">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="daily-tab" data-toggle="tab" href="#home" role="tab" aria-controls="daily" aria-selected="true">Average Daily Production</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="monthly-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="monthly" aria-selected="false">Monthly Production</a>
                </li>
                
            </ul> 
                 <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="daily-tab"> 
                
            <table id="productionTable" class='table table-striped table-borderless datatable-tab-correct datatable-tab-correct1 ' style="margin-top: 0px !important;" >
                <thead class="bg-sog ">
        ...
        ?> 
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="monthly-tab">
                <!-- <div class="tab-pane monthly-tab" id="2a"> -->
