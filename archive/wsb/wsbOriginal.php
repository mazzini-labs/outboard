        ...
        <main role="main" class="pt-5">
            ...
            <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Average Daily Production</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Monthly Production</a>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <table id="productionTable" class='table table-striped table-bordered table-sm'  >
                <thead>
                    <tr>
                        <td width="23%"></td>
                        <th width="4.5%">Avg Daily Prod</th>
                        <th width="4.5%">Monthly Prod</th>
                        <td width="21%"></td>
                    </tr>
                    <tr>
                        ...
                        <th <?php echo $width1; ?>>Gas</a></th>
                        <th <?php echo $width1; ?>>Oil</a></th>
                        <th <?php echo $width1; ?>>Water</a></th>
