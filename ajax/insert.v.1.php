 ...
 {  
      $output = '';  
      $messte = '';  
      $tc = ''; #Vendor Time (Combined)
      $dc = ''; #Vendor Cost (Combined)
      $n = '';
      $d = mysqli_real_escape_string($connect, $_POST["d-v"]);  
      $t = mysqli_real_escape_string($connect, $_POST["t-v"]);  
      $de = mysqli_real_escape_string($connect, $_POST["de-v"]);  
      $ts = mysqli_real_escape_string($connect, $_POST["ts-v"]);  
      $te = mysqli_real_escape_string($connect, $_POST["te-v"]); 
      $deb = mysqli_real_escape_string($connect, $_POST["deb-v"]);  
    //   $sd = mysqli_real_escape_string($connect, $_POST["sd"]);  
      $api = mysqli_real_escape_string($connect, $_POST["api-v"]);  
      $cvn = mysqli_real_escape_string($connect, $_POST["cvn-v"]);  
      $cin = mysqli_real_escape_string($connect, $_POST["cin-v"]);
      $drn = mysqli_real_escape_string($connect, $_POST["drn-v"]);  #Notes
      $vtt = mysqli_real_escape_string($connect, $_POST["dc-v"]);  #Time (Total) 
      $vtc = mysqli_real_escape_string($connect, $_POST["tc-v"]);  #Cost (Total)
      $id = mysqli_real_escape_string($connect, $_POST["id-v"]); 
      
      $vte = mysqli_real_escape_string($connect, $_POST["vte"]); #Time (Estimated)
      $vta = mysqli_real_escape_string($connect, $_POST["vta"]); #Time (Adjusted)
      $vca = mysqli_real_escape_string($connect, $_POST["vca"]); #Cost (Adjusted)
      ...
      if($vtt != '')
      {
          if($vte != '' || $vta != '')
          {
               if($vta != '')
               {
                    $dc .= 'Adjusted Time: ' . $vta . ' hours';
                    if($vte != '')
                    {
                         $dc .= '<hr>';
                         $dc .= 'Estimated Time: ' . $vte. ' hours';
                         $dc .= '<hr>';
                         $dc .= 'Total Time: ' . $vtt. ' hours';
                    }
                    else
                    {
                         $dc .= '<hr>';
