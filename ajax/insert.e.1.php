 ...
 {  
      $output = '';  
      $messte = '';  
      $d = mysqli_real_escape_string($connect, $_POST["d-e"]);  
      $t = mysqli_real_escape_string($connect, $_POST["t-e"]);  
      $de = mysqli_real_escape_string($connect, $_POST["de-e"]);  
      $ts = mysqli_real_escape_string($connect, $_POST["ts-e"]);  
      $te = mysqli_real_escape_string($connect, $_POST["te-e"]);
      $deb = mysqli_real_escape_string($connect, $_POST["deb-e"]);  
    //   $sd = mysqli_real_escape_string($connect, $_POST["sd"]);  
      $api = mysqli_real_escape_string($connect, $_POST["api-e"]);  
      $cvn = mysqli_real_escape_string($connect, $_POST["cvn-e"]);  
      $cin = mysqli_real_escape_string($connect, $_POST["cin-e"]);
      $drn = mysqli_real_escape_string($connect, $_POST["drn-e"]);  
      $dc = mysqli_real_escape_string($connect, $_POST["dc-e"]);  
      $tc = mysqli_real_escape_string($connect, $_POST["tc-e"]);  
      $id = mysqli_real_escape_string($connect, $_POST["id-e"]); 
      ...
      {     
          if(isset($_POST["ad-e"]))
          {
            $ad = mysqli_real_escape_string($connect, $_POST["ad-e"]);
      ...
      {  
          ...
          $width14 = "width=24%";
          /* $output .= '
          <div style="position:fixed;right:25;bottom:25;left:0;z-index:1030"> 
               <div class="alert alert-primary alert-dismissible fade show" role="alert">
               <strong>' . $messte . '</strong>
                         ...
                         $output .= '  
                                   <tr>
                                        ...
                                        <td class="engineering" '.$width4.'>
                                             ...
                                             <input type="button" name="view" value="view" id="'.$datarow["id"].'" class="btn btn-info btn-xs view_data-'.$datarow["d"].'" />
                                        </td>
                                   </tr>
                         '; 
                         break;
