 ...
 {  
      $output = '';  
      $messte = '';  
      $d = mysqli_real_escape_string($connect, $_POST["d-f"]);  
      $t = mysqli_real_escape_string($connect, $_POST["t-f"]);  
      $de = mysqli_real_escape_string($connect, $_POST["de-f"]);  
      $ts = mysqli_real_escape_string($connect, $_POST["ts-f"]);  
      $te = mysqli_real_escape_string($connect, $_POST["te-f"]);
      $deb = mysqli_real_escape_string($connect, $_POST["deb-f"]);  
    //   $sd = mysqli_real_escape_string($connect, $_POST["sd"]);  
      $api = mysqli_real_escape_string($connect, $_POST["api-f"]);  
      $cvn = mysqli_real_escape_string($connect, $_POST["cvn-f"]);  
      $cin = mysqli_real_escape_string($connect, $_POST["cin-f"]);
      $drn = mysqli_real_escape_string($connect, $_POST["drn-f"]);  
      $dc = mysqli_real_escape_string($connect, $_POST["dc-f"]);  
      $tc = mysqli_real_escape_string($connect, $_POST["tc-f"]);  
      $id = mysqli_real_escape_string($connect, $_POST["id-f"]); 
